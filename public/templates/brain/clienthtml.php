...
<body>
	...
	<center>
		...
		<label for="checkRadio" onchange="javascript:abrirRadio()" class="clientOnlineBox" id="laradio">
			...
			<img src="/templates/HabboDesign/client/images/radio.png" style="width:29px;height:28px;margin-left: 84px;margin-top: -17px;">
		</label>
		...
		<iframe id="client-div" src="/nitro/index.html?sso=56"></iframe>
